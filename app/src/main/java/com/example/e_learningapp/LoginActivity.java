...
public class LoginActivity extends AppCompatActivity {
    ...
    private Button verifyOTPBtn, generateOTPBtn,login_btn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edtOTP = findViewById(R.id.login_otp_ed);
        verifyOTPBtn = findViewById(R.id.verify_login_otp_btn);
        generateOTPBtn = findViewById(R.id.get_otp_login);
